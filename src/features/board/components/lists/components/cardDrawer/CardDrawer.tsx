  ...
  function CardDrawer(props, ref) {
    return (
      <Drawer title={<Title {...props} />} ref={ref}>
        <div className="flex h-full w-full flex-col overflow-auto md:max-h-[calc(100vh-5.5rem)] md:flex-row">
          <div className="flex h-full w-full flex-col overflow-auto border-b p-6 md:w-[calc(100%-20rem)] md:border-r lg:w-[calc(100%-24rem)]">
            <Description {...props} />
          </div>
